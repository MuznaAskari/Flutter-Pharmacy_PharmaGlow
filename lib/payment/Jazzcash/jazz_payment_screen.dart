...
class JazzPaymentScreen extends StatefulWidget {
  final String request;
  final String returnUrl;

  const JazzPaymentScreen(this.request, this.returnUrl);

  @override
  State<JazzPaymentScreen> createState() => _JazzPaymentScreenState();
}

class _JazzPaymentScreenState extends State<JazzPaymentScreen> {
