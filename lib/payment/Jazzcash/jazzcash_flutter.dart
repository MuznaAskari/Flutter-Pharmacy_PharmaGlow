...
import 'jazz_payment_screen.dart';
...
class JazzCashFlutter {
  ...
  Future<String> startPayment({required JazzCashPaymentDataModelV1 paymentDataModelV1, required BuildContext context}) async {
    ...
    return await Navigator.of(context).push(CupertinoPageRoute(builder: (context) => JazzPaymentScreen(request, paymentDataModelV1.ppReturnURL)));
  }
}
